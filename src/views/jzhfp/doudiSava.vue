<template>
  <div class="container">
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item label="兜底类型">
        <el-select v-model="formInline.sex" placeholder="请选择">
          <el-option label="种母猪" value="male"></el-option>
          <el-option label="核桃种植" value="female"></el-option>
        </el-select>
      </el-form-item>
...
<!--    <router-link :to="'/jzhfp/doudiInfo/'">-->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //修改的方法
      updateType() {
        jzhfp.doudiUpdateInfo(this.formInline)
          .then(response => {
            //提示信息
            this.$message({
              type: 'success',
      ...
      //添加的方法
      saveType() {
        jzhfp.doudiAddType(this.formInline)
          .then(response => {//添加成功
            //提示信息
            this.$message({
              type: 'success',
